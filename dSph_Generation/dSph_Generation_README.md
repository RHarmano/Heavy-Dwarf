<body>
    ...
    <p id = 'new'>
        Generates stars based on the Chabrier IMF and using CVs corresponding to hollow cylinders 
        with radii of r_1 = r - 0.5pc, r_2 = r + 0.5pc and h = 1 pc (+/- 0.5pc relative to chosen z)
    </p>
    <h1 id = 'legacy'>
